...
<<<<<<< HEAD
            try {
              ...
              // If briefing generation fails, still show profile is complete
              // User can retry later
            }
          }
        } else {
          // Profile not completed - will show standby message
          console.log("Profile not completed, showing standby");
        }
      } catch (err: any) {
        console.error("Dashboard error", err);
        // If it's an auth error, the App component should handle it
...
>>>>>>> 619c02e09be8e47f5eb8092a7aefaab1d7fe74fe
  ...
  const handleExecuteRoadmap = () => {
    console.debug("Executing Roadmap - Switching to placement tab");
